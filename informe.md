...
La siguiente imagen muestra el diagrama obtenido al implementar el frecuencimetro en Vivado.

![Esquema dada por Vivado](/informe/schematic.jpg)

Decisiones de diseño:
1. La base de tiempo es de 1ms en vez de 1s.
2. No hay aviso en caso de overflow de los contadores.
3. El tema del flanco positivo de la frecuencia y el como se evita contarlo varias veces.
